...
from basic_locomotion_isaaclab.assets.a2_asset import A2_CFG 
...
@configclass
class A2FlatEnvCfg(DirectRLEnvCfg):
    # env
    ...
    # robot
    robot: ArticulationCfg = A2_CFG.replace(prim_path="/World/envs/env_.*/Robot")
...
@configclass
class A2RoughBlindEnvCfg(A2FlatEnvCfg):
...
@configclass
class A2RoughVisionEnvCfg(A2RoughBlindEnvCfg):
