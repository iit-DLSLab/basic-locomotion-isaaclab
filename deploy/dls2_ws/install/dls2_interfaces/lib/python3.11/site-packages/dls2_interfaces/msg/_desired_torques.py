...
class Metaclass_DesiredTorques(type):
    """Metaclass of message 'DesiredTorques'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('dls2_interfaces')
        except ImportError:
            import logging
            import traceback
            logger = logging.getLogger(
                'dls2_interfaces.msg.DesiredTorques')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__desired_torques
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__desired_torques
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__desired_torques
            cls._TYPE_SUPPORT = module.type_support_msg__msg__desired_torques
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__desired_torques
...
class DesiredTorques(metaclass=Metaclass_DesiredTorques):
    """Message class 'DesiredTorques'."""
    ...
    _fields_and_field_types = {
        ...
        'sequence_id': 'uint32',
        'timestamp': 'double',
        'desired_torques': 'sequence<double>',
    }
    ...
    def __init__(self, **kwargs):
        ...
        self.desired_torques = array.array('d', kwargs.get('desired_torques', []))
    ...
    def __eq__(self, other):
        ...
        if self.timestamp != other.timestamp:
            return False
        if self.desired_torques != other.desired_torques:
            return False
        return True
    ...
    @builtins.property
    def desired_torques(self):
        """Message field 'desired_torques'."""
        return self._desired_torques

    @desired_torques.setter
    def desired_torques(self, value):
        if isinstance(value, array.array):
            assert value.typecode == 'd', \
                "The 'desired_torques' array.array() must have the type code of 'd'"
            self._desired_torques = value
            return
        if __debug__:
        ...
        self._desired_torques = array.array('d', value)
