...
class Metaclass_BaseState(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from dls2_interfaces.msg import Pose
            if Pose.__class__._TYPE_SUPPORT is None:
                Pose.__class__.__import_type_support__()

            from dls2_interfaces.msg import Screw
...
class BaseState(metaclass=Metaclass_BaseState):
    ...
    _fields_and_field_types = {
        ...
        'timestamp': 'double',
        'robot_name': 'string',
        'pose': 'dls2_interfaces/Pose',
        'velocity': 'dls2_interfaces/Screw',
        'acceleration': 'dls2_interfaces/Screw',
        'stance_status': 'sequence<double>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.UnboundedString(),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['dls2_interfaces', 'msg'], 'Pose'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['dls2_interfaces', 'msg'], 'Screw'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['dls2_interfaces', 'msg'], 'Screw'),  # noqa: E501
    ...
    def __init__(self, **kwargs):
        ...
        self.stance_status = array.array('d', kwargs.get('stance_status', []))
    ...
    def stance_status(self, value):
        if isinstance(value, array.array):
            assert value.typecode == 'd', \
                "The 'stance_status' array.array() must have the type code of 'd'"
        ...
        self._stance_status = array.array('d', value)
